      ...
      return {
        ...
        coaches: [
          ...
          },
          {
            ...
            'description': '<p>Samuel Ryser:</p>"Bei Veränderungen und für die persönliche Entwicklung ist die Nutzung der eigenen Ressourcen und Potenziale imminent wichtig."</p>' +
