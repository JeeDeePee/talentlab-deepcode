      ...
      <div>
        ...
        <div class="grey--text float-l position-top">
          <v-btn class="btn--dark mb-4 ml-0 mr-3 mt-4">
            <v-icon class="pr-2 beige--text">school</v-icon>
            <p class="beige--text mb-0">Kurs</p>
          </v-btn>
            ...
            <v-expansion-panel-content>
              ...
              <v-card>
                <v-card-text class="pl-0">
                  ...
                  Anwendbarkeit. Anhand interessanter Fallstudien aus dem Geschäftsalltag werden Methoden trainiert und
