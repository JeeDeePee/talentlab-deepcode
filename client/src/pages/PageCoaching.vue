        ...
        featuredCoaches: [
          {
            ...
            'description': '<p>"Stärken Sie Ihre Wirksamkeit."</p></p> </p> '
          },
          {
            'name': 'Samuel Ryser',
            'avatar': require(`@/assets/img/people/samuel-ryser.jpg`),
            'description': '<p>"Nutzen Sie Ihre Ressourcen und Potenziale bei Veränderungen und für die persönliche Entwicklung."</p>'
          },
          {
            'name': 'Daniel Fahrni',
